...
public class DrawShapeApp extends Application {
    ...
    private void drawShape(double x, double y) {
        commandManager.execute(new DrawShapeCommand(x, y, currentShape, RADIUS, centerPane));
    ...
    private void fillShape() {
        ...
        picker.setOnAction(e -> {
            ...
            commandManager.execute(new ChangeColorCommand(newColor, selectedShape));
            redoButton.setDisable(true);
        });
    }

    private void deleteShape() {
        commandManager.execute(new DeleteCommand(centerPane, selectedShape));
        redoButton.setDisable(true);
    }
