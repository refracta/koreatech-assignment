...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "EOL", "$accept", "input", "line", "exp", YY_NULLPTR
};
...
#line 1084 "parser.tab.c"
  ...
  case 8: /* exp: NUMBER MINUS exp  */
#line 31 "parser.y"
                           { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1090 "parser.tab.c"
    break;

  case 9: /* exp: NUMBER MULTIPLY exp  */
#line 32 "parser.y"
                              { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1096 "parser.tab.c"
    break;

  case 10: /* exp: NUMBER DIVIDE exp  */
#line 33 "parser.y"
                            { (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); }
